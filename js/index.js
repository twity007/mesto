...
const popupCloseAdd = document.querySelector(".popup_js_close-add");
const popupClosePreview = document.querySelector(".popup_js_close-preview");
const popupCloseEdit = document.querySelector(".popup_js_close-edit");
